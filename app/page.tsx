...
import { getTotalStats, WAITLIST_COPY } from "@/lib/waitlist";
    ...
    >
      <div style={{ width: "100%", maxWidth: 520 }}>
        ...
        >
          ...
          >
            {stats.count} på ventelisten · Vi spammer ikke.
          </p>
        </div>
        ...
        <div style={{ marginTop: 18, textAlign: "center", color: "#6B7690", fontSize: 12 }}>
          Del dit referral-link efter signup for at hoppe køen over.
        </div>
      </div>
    </main>
  );
