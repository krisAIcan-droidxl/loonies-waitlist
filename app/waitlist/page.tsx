...
export default async function WaitlistPage(props: {
  ...
  async function action(formData: FormData): Promise<void> {
    ...
    // VALIDATION: only first_name and email are required
    if (!first_name || !email) {
  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        {success && (
          <ThankYouClient position={pos ? parseInt(pos, 10) : null} code={code || null} />
        )}
            ...
            <div style={{ lineHeight: 1.4 }}>
              ...
              <div style={{ color: "#A7B0C0", fontSize: 13, marginTop: 6 }}>
                {error === "duplicate"
                  ...
                  : error === "validation"
                    ? "Udfyld venligst fornavn og email."
        ...
        >
          <form action={action}>
            ...
            <div style={{ marginTop: 14 }}>
              ...
              >
                Hvad kunne du finde på at mødes om? (valgfrit)
              </div>
